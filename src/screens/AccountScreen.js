  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.menuContainer}>
        <TouchableOpacity 
          style={styles.menuItem} activeOpacity={0.8}
        ...
        >
          ...
          <Text style={styles.menuText}>Lịch sử {'\n'}đặt hàng</Text>
        </TouchableOpacity>
      ...
      <View style={styles.mainContainer}>
        ...
        <TouchableOpacity style={styles.sectionContainer} activeOpacity={0.8}>
          <View style={styles.sectionTextContainer}>
            ...
            >
              <Text style={styles.sectionText}>Quản lí</Text>
            </TouchableOpacity>
          </View>
          <Feather
            name="chevron-right"
        ...
        <TouchableOpacity style={styles.sectionContainer} activeOpacity={0.8}>
          <View style={styles.sectionTextContainer}>
            <Ionicons
              ...
              color={Colors.DEFAULT_GREEN}
            />
            <Text style={styles.sectionText}>Phương thức thanh toán</Text>
          </View>
          <Feather
            name="chevron-right"
            color={Colors.INACTIVE_GREY}
